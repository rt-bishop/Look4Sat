...
import com.rtbishop.look4sat.databinding.DialogEntriesBinding
import com.rtbishop.look4sat.ui.adapters.EntriesAdapter
import java.util.*

class EntriesDialog(private var entries: MutableList<SatEntry>) :
    AppCompatDialogFragment(), SearchView.OnQueryTextListener {

    private lateinit var entriesListener: EntriesSubmitListener
    private val entryAdapter = EntriesAdapter(entries)
    private var selectAllToggle = true

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val binding = DialogEntriesBinding.inflate(requireActivity().layoutInflater)
        ...
        binding.dialogSearch.apply {
            setOnQueryTextListener(this@EntriesDialog)
    ...
    fun setEntriesListener(listener: EntriesSubmitListener): EntriesDialog {
